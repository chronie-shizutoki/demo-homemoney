...
export const DebtAPI = {
  ...
  async getDebts (params = {}) {
    try {
      console.log('BrowserDB: 获取债务记录');
      const debts = await browserDB.getDebts(params);
      return debts;
    } catch (error) {
      console.error('BrowserDB: 获取债务记录失败:', error);
      throw error;
    }
  },
  ...
  async addDebt (data) {
    try {
      console.log('BrowserDB: 添加债务记录');
      return await browserDB.addDebt(data);
    } catch (error) {
      console.error('BrowserDB: 添加债务记录失败:', error);
      throw error;
    }
  },
  ...
  async updateDebt (id, data) {
    try {
      console.log('BrowserDB: 更新债务记录');
      return await browserDB.updateDebt(id, data);
    } catch (error) {
      console.error('BrowserDB: 更新债务记录失败:', error);
      throw error;
    }
  },
  ...
  async deleteDebt (id) {
    try {
      console.log('BrowserDB: 删除债务记录');
      await browserDB.deleteDebt(id);
    } catch (error) {
      console.error('BrowserDB: 删除债务记录失败:', error);
      throw error;
    }
  }
};