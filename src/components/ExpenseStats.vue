    ...
    <div class="stats-container">
      <div class="stats-summary">
        ...
        <div class="stat-item">
          ...
          <span class="stat-value">{{ $t('common.currency') }}{{ statistics.totalAmount }}</span>
        </div>
        <div class="stat-item">
          <span class="stat-label">{{ $t('expense.stats.averageAmount') }}：</span>
          <span class="stat-value">{{ $t('common.currency') }}{{ statistics.averageAmount }}</span>
        </div>
        <div class="stat-item">
          <span class="stat-label">{{ $t('expense.stats.medianAmount') }}：</span>
          <span class="stat-value">{{ $t('common.currency') }}{{ statistics.medianAmount }}</span>
        </div>
        <div class="stat-item">
          <span class="stat-label">{{ $t('expense.stats.amountRange') }}：</span>
          <span class="stat-value">{{ $t('common.currency') }}{{ statistics.minAmount }}-{{ $t('common.currency') }}{{ statistics.maxAmount }}</span>
        </div>
      </div>
    </div>
  </template>
